...
-- public.follower foreign keys

ALTER TABLE public.follower ADD CONSTRAINT follower_follower_id_fkey FOREIGN KEY (follower_id) REFERENCES public.users(id);
ALTER TABLE public.follower ADD CONSTRAINT follower_following_id_fkey FOREIGN KEY (following_id) REFERENCES public.users(id);

-- public.hobbies definition
...
-- public.hobbies foreign keys

ALTER TABLE public.hobbies ADD CONSTRAINT hobbies_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE public.notification ADD CONSTRAINT notification_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE public.posts ADD CONSTRAINT posts_comments_id_fkey FOREIGN KEY (comments_id) REFERENCES public.posts(id);
ALTER TABLE public.posts ADD CONSTRAINT posts_comments_id_fkey1 FOREIGN KEY (comments_id) REFERENCES public.posts(id);
